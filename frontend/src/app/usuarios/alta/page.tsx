    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        input.error-input:focus, select.error-input:focus {
          border-color: #f87171;
          box-shadow: 0 0 0 3px #f8717112;
        }
      ...
      <div className="shell">
        {/* Barra superior eliminada: la provee el layout principal */}
        ...
        <main className="main">
          ...
          <div className="page-header">
            ...
            <p className="page-subtitle">
              Completá los datos del nuevo usuario administrativo del sistema.
            </p>
          </div>
            ...
            <div className="form-grid">
              ...
              <div className="form-group full">
                ...
                {errors.nombreUsuario
                  ...
                  : <span style={{ fontSize: "0.7rem", color: "#334155" }}>Debe ser único en el sistema. Solo minúsculas, sin espacios.</span>
                }
              </div>
