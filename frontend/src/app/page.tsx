      ...
      <div className="shell">
        ...
        <main className="main">
          ...
          <p className="page-subtitle">
            Seleccioná una opción para comenzar. Las funcionalidades marcadas como “Próximamente” se habilitarán
            a medida que tus compañeros las implementen.
          </p>
          ...
          <div className="menu-grid">
            ...
            <div className="menu-card disabled">
              ...
              <div className="menu-card-desc">Registrar una nueva licencia en el sistema.</div>
            ...
            <div className="menu-card disabled">
              ...
              <div className="menu-card-desc">Generar e imprimir una licencia en formato PDF.</div>
              <span className="badge">Próximamente</span>
            </div>
            ...
            <div className="menu-card disabled">
              ...
              <div className="menu-card-desc">Extender la vigencia de una licencia existente.</div>
              <span className="badge">Próximamente</span>
            </div>

            {/* 4. Emitir copia (próximamente) */}
            <div className="menu-card disabled">
              <div className="menu-card-icon">
                <svg viewBox="0 0 24 24">
              ...
              <div className="menu-card-desc">Duplicar una licencia emitida anteriormente.</div>
              <span className="badge">Próximamente</span>
            </div>
            ...
            <div className="menu-card disabled">
              ...
              <div className="menu-card-title">Listado de licencias expiradas</div>
              <div className="menu-card-desc">Ver todas las licencias que superaron su fecha de vencimiento.</div>
              <span className="badge">Próximamente</span>
            </div>
            ...
            <div className="menu-card disabled">
              ...
              <div className="menu-card-desc">Filtrar licencias activas según tipo, persona u otros parámetros.</div>
              <span className="badge">Próximamente</span>
            </div>
            ...
            <Link href="/usuarios" className="menu-card">
              ...
              <div className="menu-card-title">Listado de usuarios administrativos</div>
              <div className="menu-card-desc">Administrar los usuarios del sistema: altas, bajas y modificaciones.</div>
            </Link>
          </div>
        </main>
      </div>
