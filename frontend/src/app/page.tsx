      ...
      <div className="shell">
        <main className="main">
          ...
          <div className="menu-grid">
            ...
            {/* 2. Listado de titulares (ABM) */}
            <Link href="/titulares" className="menu-card">
              <div className="menu-card-icon">
                <svg viewBox="0 0 24 24">
                  <path
                    strokeLinecap="round"
              ...
              <div className="menu-card-title">Listado de titulares</div>
              <div className="menu-card-desc">
                Administrar los titulares: altas, bajas y modificaciones.
              </div>
            </Link>
