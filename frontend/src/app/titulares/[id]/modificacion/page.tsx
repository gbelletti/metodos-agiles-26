...
export default function ModificacionTitularPage() {
    ...
    fetch(`${API_URL}/titulares/${id}`)
      ...
      .then((data) => {
        setForm({
          ...
          claseSolicitada: data.claseSolicitada ?? "",
          grupoSanguineo: data.grupoSanguineo ?? "",
          factorRH: data.factorRH === true ? "true" : "false",
          donante: data.donante === true ? "true" : "false",
        });
      })
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .fetch-error { padding: 3rem 2rem; text-align: center; }
      ...
      <div className="shell">
        <main className="main">
          ...
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-current">Modificar titular</span>
          </nav>

          <div className="page-header">
            <p className="page-eyebrow">Gestión de titulares</p>
            <h1 className="page-title">Modificar titular</h1>
            <p className="page-subtitle">Editá los datos del titular. Todos los campos son obligatorios.</p>
          </div>
          ...
          <div className="form-card">
            ...
            {fetchError && (
              <div className="fetch-error">
                <p className="fetch-error-title">No se pudo cargar el titular</p>
              ...
              <>
                ...
                {exitoso && (
                  <div className="alert-success">
                    ...
                    ¡Titular modificado correctamente! Redirigiendo...
                  </div>
                )}
                ...
                <div className="form-grid">
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" value={form.apellido} onChange={(e) => handleChange("apellido", e.target.value)} className={errors.apellido ? "error-input" : ""} />
                    {errors.apellido && <span className="field-error">⚠ {errors.apellido}</span>}
                  </div>

                  <div className="form-group">
                    <label>Nombre <span className="required">*</span></label>
                    <input type="text" value={form.nombre} onChange={(e) => handleChange("nombre", e.target.value)} className={errors.nombre ? "error-input" : ""} />
                    {errors.nombre && <span className="field-error">⚠ {errors.nombre}</span>}
                  </div>

                  <div className="form-group">
                    <label>Fecha de nacimiento <span className="required">*</span></label>
                    <input type="date" value={form.fechaNacimiento} onChange={(e) => handleChange("fechaNacimiento", e.target.value)} className={errors.fechaNacimiento ? "error-input" : ""} />
                  ...
                  <div className="form-group">
                    ...
                    <input type="text" value={form.direccion} onChange={(e) => handleChange("direccion", e.target.value)} className={errors.direccion ? "error-input" : ""} />
                ...
                {/* Sección: Licencia y datos médicos */}
                ...
                <div className="form-actions">
                  ...
                  <button className="btn-submit" onClick={handleSubmit} disabled={loadingSave || exitoso}>
                    {loadingSave
